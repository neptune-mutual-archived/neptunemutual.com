...
export const data = [
  ...
  {
    name: <Trans>Protocol Mainnet Launch - Avalanche</Trans>,
    description: (
      <Trans>
        The protocol will be launched on mainnet. In the first instance a
        centralised voucher system will be used with trusted Neptune Mutual
  ...
  {
    name: <Trans>Public Sale</Trans>,
    description: (
      <Trans>
        A public sale and TGE will mark the official launch of the complete
        Neptune Mutual marketplace in which the NPM token is used for a variety
        of operations within the marketplace.
      </Trans>
    ),
  },
  {
    ...
    description: (
      <Trans>
        Neptune Mutual team partners with blockchain security experts, groups,
        and companies to “conceptualize” a brand new security analytics service
        exclusively for our portfolio projects. The dashboard will be based on
